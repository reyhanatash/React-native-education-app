// import StartExam from '../screens/Exam';
...
export const Screens = {
    ...
    DedicatedExam:'DedicatedExam',
    ReportCard:'ReportCard'
    // InformationSpcificCourse:'InformationSpcificCourse'

};

export const Strings = {
  /*******global *****/
  TotalQuestion:"تعداد سوالات",
  GoToClass:"برو به کلاس",
  lesson:"نام درس",
  sentFile:"پاسخ ارسال شد",
  downloadAnswers:"دانلود پاسخنامه",
  UploadAnswer:"آپلود پاسخ تکلیف",
  dowloadHomework:"دانلود تکلیف",
  QuestionAnswer:"دریافت سوالات و پاسخنامه",
  ...
  /************offline*******************/
  fileDl: 'دانلود جزوه',
  EnterExam:"ورود به آزمون",
  succeedCensure: 'نظر شما با موفقیت ارسال شد',
  StartExam:'شروع آزمون',
  Exam:"آزمون",
  Notifications:"تذکرات",
  note1:'سوالات آزمون به صورت تصادفی از بانک سوالات موجودانتخاب شده است. ',
  note2:"فرصت شرکت در آزمون ها برای هر داوطلب یکبار خواهد بود.",
  note3:" به محض ورود داوطلب به آزمون زمان آزمون محاسبه خواهد شد. به همین دلیل پس از کسب آمادگی کامل وارد آزمون شوید. ",
  examInfo:'اطلاعات',
  ExamTime:'زمان آزمون',
  NumberExam:' تعداد سوالات آزمون',
  TotalQuestionNumber:'تعداد کل سوالات',
  YoureTime:'زمان شما',
  CorrctAnswer:'پاسخ صحیح',
  WrongAnswer:'پاسخ غلط',
  WithoutAnswer:'بدون پاسخ',
  Percent:'درصد'
};
...
export const StaticObjects = {
  imagePlaceholdr:
  'https://api.famiran.com/files/course/e99888d6-2ea5-45b9-8072-37a347a1aadf.jpg',
